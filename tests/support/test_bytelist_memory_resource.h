// Modified to test bytelist's memory_resource
...
#ifndef SUPPORT_TEST_BYTELIST_MEMORY_RESOURCE_H
#define SUPPORT_TEST_BYTELIST_MEMORY_RESOURCE_H
...
#endif /* SUPPORT_TEST_BYTELIST_MEMORY_RESOURCE_H */
